...
**Phase 4 in progress:** `JN-20` (parser), `JN-24` (event→transition) done.
**Next: `JN-23`.**
...
**Next action:** implement **`JN-23`** (link writer), TDD.
...
> **Order:** `JN-23` → `JN-36` → `JN-21` → `JN-22` → `JN-37`. (`JN-20`, `JN-24` ✅ done.)
